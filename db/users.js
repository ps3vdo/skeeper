...
class UsersServices {
    ...
    async update(first_name, last_name, email, id) {
        return await db.query('UPDATE owner set first_name = $1, last_name = $2 email = $3, updated_at = $4 where id = $5 RETURNING *',
            [first_name, last_name, email, id, this.currentDate]);
