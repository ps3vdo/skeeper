...
const apiError = require('../error/ApiError')
    ...
    async function create (email, hash_password, salt, first_name, last_name) {
        try {
            return db.query('INSERT INTO users (email, hash_password, salt, first_name, last_name, created_at) values ($1, $2, $3, $4, $5, $6) RETURNING id, email',
    ...
    async function createRefreshToken(id, token) {//TODO запись токена в бд
    }
...
module.exports = {create, getUser, getUsers, validate, createRefreshToken, update, deleteUser}
